...
public class ElasticDualPortRestExecutor implements ElasticRawRestExecutor {

    private ElasticRawRestExecutor readExecutor;
    private ElasticRawRestExecutor writeExecutor;
